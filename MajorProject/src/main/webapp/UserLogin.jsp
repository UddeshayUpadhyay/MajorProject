...
<body>
 ...
 <form action="UserLogin" method="post">
  <div class="form-group">
              <input type="text" name="email" maxlength="100" class="form-control" placeholder=" ID" required/>
            </div>
            <div class="form-group">
 ...
 <form action="UserRegister" method="post">
  <div class="form-group">
              <input type="email" name="email" maxlength="100" class="form-control" placeholder="Email" required/>
            </div>
            <div class="form-group">
              <input type="text" name="name" pattern="[a-zA-Z]+" maxlength="100" class="form-control" placeholder="Name"  required/>
            </div>
            <div class="form-group">
              <input type="password"name="password" maxlength="50" class="form-control" placeholder=" Password" required/>
            </div>
             <div class="form-group">
              <input type="number"name="phone" patern="[0-9]+" maxlength="10" class="form-control" placeholder=" Phone" required/>
            </div>
