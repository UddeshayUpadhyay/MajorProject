  ...
  <nav class="navbar navbar-expand-sm container">
      ...
      <div class="collapse navbar-collapse" id="my-navbar">
          <ul class="navbar-nav  mx-auto">
            ...
            <a class="nav-link" href="AllItem.jsp">Items</a>
            <li>
              <a class="nav-link" href="">menu</a>
            </li>
          </ul>
          <p>Welcome: <b><%= adminname %></b> <a href=logout class="btn btn-sm btn-danger">Logout</a></p>
      </div>
  </nav>
  <header class="container mt-4 p-5">
      ...
      <form action="AddItem" method="post" enctype="multipart/form-data">
            <div class="form-group">
              <input type="text" name="name" pattern="[a-zA-Z0-9- ]+" maxlength="100" class="form-control" placeholder="Name" required/>
            </div>
            <div class="form-group">
              <input type="text" name="cname" pattern="[a-zA-Z0-9- ]+" maxlength="100" class="form-control" placeholder="CName" required/>
            </div>
             
            <div class="form-group">
              <input type="text" name="salt" pattern="[a-zA-Z0-9- ]+" maxlength="10" class="form-control" placeholder="Salt(if Applicable)" />
            </div>
            <div class="form-group">
              <input type="text" name="price" pattern="[0-9.]+" maxlength="10" class="form-control" placeholder="Price" required/>
            </div>
            <div class="form-group">
              <input type="number" name="qty" min="1" maxlength="10" class="form-control" placeholder="Quantity" required/>
            </div>
            <div class="form-group">
