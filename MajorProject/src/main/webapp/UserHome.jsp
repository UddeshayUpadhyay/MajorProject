...
<body>
  ...
  <nav class="navbar navbar-expand-sm container">
      ...
      <div class="collapse navbar-collapse" id="my-navbar">
          <ul class="navbar-nav  mx-auto">
            ...
            <li>
              <a class="nav-link" href="UserOrders.jsp">All Orders</a>
            </li>
          </ul>
          <p>
  ...
  <header class="container mt-4">
     ...
     <div class="form-row">
      <div class="col-9">
      <input type="text" name="name"  class="form-control" placeholder="Medicine Name/Product Name"/>
     
      </div>
      <div class="col-2 m-1"> <button type="submit" class="btn btn-sm btn-success">Search</button></div>
    </div>
      </form>
  </header>
